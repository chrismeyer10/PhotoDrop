...
// Alle Farben der App an einem Ort.
// Dark Theme: sehr dunkle Hintergründe, roter Akzent, weißer Text.
val AppHintergrund = Color(0xFF0A0A0A)      // Hintergrund der gesamten App
