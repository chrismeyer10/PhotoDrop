...
// Ermoeglicht dem User, Dateiname und Drive-Pfad manuell einzugeben.
@Composable
fun DokumentManuellBenennenInhalt(
    ...
    var drivePfad by remember { mutableStateOf("Dokumente") }
    ...
    Column(
        ...
        OutlinedTextField(
            ...
            label = { Text("Drive-Pfad (z.B. Dokumente/2026)", color = TextGedaempft) },
            modifier = Modifier.fillMaxWidth(),
            colors = textFeldFarben(),
            singleLine = true
        )
